...
caminho_velho = Path(r'captacao_diario\arquivos\2022\Janeiro\positivador_310122.xlsx') #! último positivador do mês anterior
...
caminho_m1 = Path(r'captacao_diario\arquivos\2022\Janeiro\captacao_310122.xlsx') #!
caminho_m2 = Path(r'captacao_diario\arquivos\2021\Dezembro\captacao_301221.xlsx') #!
...
nm1 = 21 #!
nm2 = 23 #!
nm =  19  #!nº de dias uteis até o positivador

#Nomes dos meses passados

captacao_m1 = 'Total captado Janeiro'
captacao_m2 = 'Total captado Dezembro'
media_m1 = 'Média diária Janeiro'
media_m2 = 'Média diária Dezembro'
